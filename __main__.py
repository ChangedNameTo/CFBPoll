...
# Testing runs need special frames to roll up the year over year stats
if TESTING:
...
for iter_year in range(START_YEAR, YEAR + 1):
    ...
    teams = pd.read_csv('data/{}/teams.csv'.format(iter_year))
    ...
    games.to_csv('./data/{}/processed_games.csv'.format(iter_year))
